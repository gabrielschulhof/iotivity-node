...
function( assignIn, find, isEqual, bind, bindKey, csdk, resolver, querystring, listenerCount,
	util, events ) {

var _ = { extend: assignIn, find: find, isEqual: isEqual, bind: bind, bindKey: bindKey };
...
util.inherits( ClientHandles, events.EventEmitter );
