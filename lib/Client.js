...
client = _.extend( new Client(), {
	...
	create: function( resourceInit, target ) {
		var options = _.extend( target ? _.extend(
			target._private && target._private.origin ? {
				deviceId: null,
				requestUri: target._private.origin + target.resourcePath
			} : {
	...
	delete: function( resourceId ) {
		...
		}, resourceId._private && resourceId._private.origin ? {
			requestUri: resourceId._private.origin + resourceId.resourcePath,
			deviceId: null
		} : {
