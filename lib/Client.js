...
function establishDestination( resourceId, endpoint ) {
	return endpoint ? {
		deviceId: null,
		requestUri: endpoint.origin + resourceId.requestUri
	} : resourceId;
}
			...
			.then( function( resource ) {
				...
				return listener ?
					new Promise( function( fulfill, reject ) {
						var result = ClientResource.observe( resource, query, fulfill, reject );
