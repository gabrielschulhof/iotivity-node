...
function( assignIn, findKey, isEqual, bind, remove, csdk, ServerResource, querystring, payload,
	Request ) {

var _ = { extend: assignIn, findKey: findKey, isEqual: isEqual, bind: bind, remove: remove };
