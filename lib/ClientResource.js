...
function( findIndex, assignIn, pick, util, csdk, payload, handles, events, listenerCount ) {
...
util.inherits( ClientResource, events.EventEmitter );
...
ClientResource.observe = function( resource, fulfill, reject ) {
	...
	if ( !resource._private.observer ) {
		result = handles.replace( observeParams( resource ), updateResource );
